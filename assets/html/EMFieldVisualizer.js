...
// include: /var/folders/bp/k3kx8znx5kz6y45zh5gv4gkc0000gn/T/tmppggaa_tk.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'EMFieldVisualizer.data';
      var REMOTE_PACKAGE_BASE = 'EMFieldVisualizer.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_EMFieldVisualizer.data');

      };
      Module['addRunDependency']('datafile_EMFieldVisualizer.data');
    ...
    loadPackage({"files": [{"filename": "/assets/.DS_Store", "start": 0, "end": 6148}, {"filename": "/assets/arial.ttf", "start": 6148, "end": 779384}, {"filename": "/assets/arrow.png", "start": 779384, "end": 793542}], "remote_package_size": 793542});

  })();

// end include: /var/folders/bp/k3kx8znx5kz6y45zh5gv4gkc0000gn/T/tmppggaa_tk.js
// include: /var/folders/bp/k3kx8znx5kz6y45zh5gv4gkc0000gn/T/tmpymydf62w.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/bp/k3kx8znx5kz6y45zh5gv4gkc0000gn/T/tmpymydf62w.js
// include: /var/folders/bp/k3kx8znx5kz6y45zh5gv4gkc0000gn/T/tmp0d2rkl16.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/bp/k3kx8znx5kz6y45zh5gv4gkc0000gn/T/tmp0d2rkl16.js
...
function findWasmBinary() {
    return locateFile('EMFieldVisualizer.wasm');
}
